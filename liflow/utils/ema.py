# EMA utilities adapted from https://github.com/BioinfoMachineLearning/bio-diffusion
...
class EMA(Callback):
    ...
    def on_load_checkpoint(
        ...
        if trainer.ckpt_path and checkpoint_callback is not None:
            ...
            if trainer.ckpt_path.endswith(f"_ema{ext}"):
                log.info(
                ...
                return
            ema_path = trainer.ckpt_path.replace(ext, f"_ema{ext}")
...
class EMAModelCheckpoint(ModelCheckpoint):
    ...
    def _ema_format_filepath(self, filepath: str) -> str:
        return filepath.replace(self.FILE_EXTENSION, f"_ema{self.FILE_EXTENSION}")
    ...
    def _update_best_and_save(
        ...
        if del_filepath is not None and filepath != del_filepath:
            ...
            self._remove_checkpoint(
                trainer,
                del_filepath.replace(self.FILE_EXTENSION, f"_ema{self.FILE_EXTENSION}"),
            )
